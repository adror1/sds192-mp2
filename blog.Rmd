...
cand_info <- function(cand_table) {
  cand_table %>%
    ...
    select(cand_id, cand_name, cand_party_affiliation, cand_state, cand_election_yr, cand_office, cand_office_district, total_for, total_against, total, primary_votes, general_votes, ge_winner)
}
